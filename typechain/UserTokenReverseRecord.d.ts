...
interface UserTokenReverseRecordInterface extends ethers.utils.Interface {
  functions: {
...
export class UserTokenReverseRecord extends BaseContract {
  ...
  interface: UserTokenReverseRecordInterface;
